...
class IsnareAnswers_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'isnare-answers'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'isnare-answers'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'isnare-answers'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'isnare-answers'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'isnare-answers');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'isnare-answers'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'isnare-answers');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'isnare-answers'); ?></h2>
			
			<div>Get your API Keys for free here: <a href="https://www.isnare.org/api_widgets/" target="_new">https://www.isnare.org/api_widgets/</a></div>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'isnare-answers') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'isnare-answers');
            case 'false':
                return __('false', 'isnare-answers');

            case 'Administrator':
                return __('Administrator', 'isnare-answers');
            case 'Editor':
                return __('Editor', 'isnare-answers');
            case 'Author':
                return __('Author', 'isnare-answers');
            case 'Contributor':
                return __('Contributor', 'isnare-answers');
            case 'Subscriber':
                return __('Subscriber', 'isnare-answers');
            case 'Anyone':
                return __('Anyone', 'isnare-answers');
        }
        return $optionValue;
    }
